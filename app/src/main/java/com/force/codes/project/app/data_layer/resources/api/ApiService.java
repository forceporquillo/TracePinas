...
public interface ApiService {
  @GET
  Flowable<List<CountryDetails>> getSortedCases(@Url String url);

  @GET
  Flowable<List<GlobalData>> getGlobalData(@Url String url);

  @GET
  Flowable<LocalData> getPhData(@Url String url);

  @GET
  Flowable<WorldData> getWorldData(@Url String url);

  @GET
  Flowable<NewsData> getNewsResponse(@Url String url);

  @GET
  Flowable<List<TwitterData>> getTwitterResponse(@Url String url);

  @GET
  Flowable<List<TotalByDate>> getTotalByDate(@Url String url);
