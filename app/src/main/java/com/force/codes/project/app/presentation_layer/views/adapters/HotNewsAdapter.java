...
public class HotNewsAdapter extends PagedListAdapter<ArticlesItem, HotNewsViewHolder> {
  ...
  @NonNull
  @Override public HotNewsViewHolder
  ...
  @Override public void onBindViewHolder(@NonNull HotNewsViewHolder holder, int position) {
  ...
  private static DiffUtil.ItemCallback<ArticlesItem> DIFF_CALLBACK = new DiffUtil
    ...
    @Override public boolean areContentsTheSame(@NonNull ArticlesItem oldItem,
